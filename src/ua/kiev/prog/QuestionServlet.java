...
public class QuestionServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        String res ="Dear <p> "+ firstName+ " "+ lastname +"<p/>"+" Thank you for your answers!"+
                "<br>This is the statistics of your answers: </br>"+
                "<p>Question 1: yes = " +  results[QUESTION_1_YES] + ", no = " + results[QUESTION_1_NO] + "</p>";
